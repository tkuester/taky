...
class TAKUserTestcase(ut.TestCase):
    ...
    def test_as_element(self):
        ...
        tak_u.last_seen = isoparse(self.answer.get("time")).replace(tzinfo=None)
        tak_u.stale = isoparse(self.answer.get("stale")).replace(tzinfo=None)
